            ...
            <div className={`min-h-screen transition-colors duration-300 ${
                ...
                <header className={`w-full py-4 sm:py-6 flex justify-center items-center mb-4 ${
                    ...
                    <div className="flex items-center">
                        <svg className="w-8 h-8 sm:w-10 sm:h-10 text-gray-100" viewBox="0 0 16 16"
                             fill={isDarkMode ? "#f0f6fc" : "#24292f"}>
                            <path fillRule="evenodd"
                                  d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path>
                        </svg>
                        <span className={`text-xl sm:text-3xl ml-2 sm:ml-3 font-bold ${
                ...
                <div className="w-full py-4 flex justify-center items-center">
                    <div className="relative w-40 sm:w-auto">
                        ...
                        <ul className={`absolute w-full border rounded-md shadow-lg mt-2 z-10 ${
                            isOpenLang ? 'block' : 'hidden'
                        } ${
                ...
                <div className="container mx-auto max-w-xl px-4">
                    <div className="relative mb-6">
                        <div className={`flex overflow-hidden rounded-lg ${
                            ...
                            <button
                                ...
                                disabled={loading}
                                className={`px-4 sm:px-5 flex items-center justify-center transition-colors duration-200 ${
                                    isDarkMode
                    ...
                    {error && (
                        <div className={`p-4 sm:p-5 rounded-lg mb-6 text-center ${
                            isDarkMode ? 'bg-gray-800 border border-red-700' : 'bg-gray-100 border border-red-300'
                        }`}>
                            <p className={`font-medium ${isDarkMode ? 'text-red-400' : 'text-red-500'}`}>{error}</p>
                            <p className={`font-medium ${isDarkMode ? 'text-red-400' : 'text-red-500'}`}>{PathLang.tryAgain}</p>
                        </div>
                    )}
                            ...
                            <div className="flex flex-col">
                                <div className={`w-full flex justify-center py-4 ${
                                    ...
                                    <img
                                        ...
                                        className="w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 object-cover rounded-full"
                                    />
                                </div>
                                ...
                                <div className="p-4 sm:p-6">
                                    <div className="flex flex-col items-center">
                                        ...
                                        {userData.bio && (
                                            <p className={`my-3 sm:my-4 text-center max-w-md ${
                                        ...
                                        <div className="mt-4 grid grid-cols-3 gap-2 sm:gap-6 w-full max-w-md">
                                            <div className="text-center">
                                                <p className={`text-lg sm:text-xl font-bold ${
                                                    isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                                }`}>{userData.followers.toLocaleString()}</p>
                                            ...
                                            <div className="text-center">
                                                <p className={`text-lg sm:text-xl font-bold ${
                                                    isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                                }`}>{userData.following.toLocaleString()}</p>
                                                <p className={`text-xs sm:text-sm ${
                                                    isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                                }`}>
                                                    {PathLang.following}
                                            ...
                                            <div className="text-center">
                                                <p className={`text-lg sm:text-xl font-bold ${
                                                    isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                                }`}>{userData.public_repos.toLocaleString()}</p>
                                                <p className={`text-xs sm:text-sm ${
                                                    isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                                }`}>
                                        ...
                                        <a
                                            ...
                                            className={`w-full max-w-md mt-4 sm:mt-6 py-2 px-4 rounded text-center transition-colors duration-200 ${
                                                isDarkMode
